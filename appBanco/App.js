  ...
  render(){
    ...
    return(
      <View style={styles.container}>
        <Text style={styles.textoTittle}>Cadastrar uma nova conta: </Text>

        <Text style={styles.textoDados}>Nome: </Text>
        <TextInput style={styles.input} placeholder="Digite seu nome: " onChangeText={nomeUser => {this.setState({ nomeUser });}} />

        <Text style={styles.textoDados}>Idade: </Text>
        <TextInput style={styles.input} placeholder="Digite sua idade: " onChangeText={idadeUser => {this.setState({ idadeUser });}} keyboardType="numeric" />
