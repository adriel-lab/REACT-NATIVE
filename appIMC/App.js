...
export default class App extends React.Component {
  ...
  calcular() {
    ...
    if (this.state.massa < 10 || this.state.massa > 200) {
      ...
      this.state.resultTexto = "Baixo peso Grau 1°!";
    } else if (this.state.resultado < 17) {
      this.state.resultTexto = "Baixo peso Grau 2°!";
    } else if (this.state.resultado < 18.5) {
      this.state.resultTexto = "Baixo peso Grau 3°!";
    } else if (this.state.resultado < 25) {
      this.state.resultTexto = "Peso adequado!";
  ...
  render() {
    return (
      <View style={styles.container}>
        <Text style={styles.textoTittle}>Cálculadora de IMC</Text>
        ...
        <View style={styles.entrada}>
          <TextInput
            autoCapitalize="none"
            placeholder="Digite seu seu peso:"
